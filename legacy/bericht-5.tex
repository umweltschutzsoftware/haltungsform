...
\textbf{Adresse} & Holsen 7 \\[0.1cm] % Ändern
\textbf{Ort} & 59075 Hamm \\[0.1cm] % Ändern
\end{tabularx}
...
% Ändern
\textbf{Projektnummer} & G-6814-01 \\[0.1cm]
\textbf{Datum} & \today \\
\end{tabularx}
...
%Ändern
Das vorliegende Vorhaben betrifft die Ergänzung von Ausläufen.
\begin{table}[h!]
\centering
\renewcommand{\arraystretch}{1.5}
...
%Ändern
Der Betrieb befindet sich im Außenbereich der Stadt Schwerte, Gemarkung Bockum-Hövel, Flur 30, Flurstück 218 inmitten weiterer landwirtschaftlicher Betriebe sowie schutzbedürftiger Nutzungen. Die Lage kann aus immissionsschutzfachlicher Sicht als schwierig eingestuft werden. Eine Übersicht über den Standort kann der Abbildung \ref{fig:lageplan} entnommen werden. 
\begin{figure}[htbp]
    \centering
...
\hline
% Ändern
\textbf{Begründung}&\cellcolor{ampelYellow!30} Hohe Anzahl& \cellcolor{ampelYellow!30}Integrierte Lage \\
\hline
\end{tabularx}
...
\hline
% Ändern
\textbf{Begründung}&\cellcolor{ampelYellow!30} Betriebe prüfen & \cellcolor{ampelYellow!30} Hohe Vorbelastung  \\
\hline
\end{tabularx}
...
\hline
01 & Mastschweine & 428 & 1 & Ja & Ja \\
04 & Mastschweine & 400 & 1 & Ja & Ja \\
05 & Mastschweine & 400 & 1 & Ja & Ja \\
% Ändern
\hline
\end{tabularx}
...
\hline
01 & Mastschweine & 428 & 2 \\
04 & Mastschweine & 400 & 2 \\
05 & Mastschweine & 400 & 2 \\
% Ändern
\hline
\end{tabularx}
...
\hline
% Ändern
\textbf{Begründung}&\cellcolor{ampelGreen!30} & \cellcolor{ampelRed!30}Verschlechterung der Ausbreitungssituation \\
\hline
\end{tabularx}
...
% Ändern
In diesem Projekt erwarten wir aus immissionsschutzfachlicher Sicht Probleme, da im Ist-Zustand bereits sehr gute Ableitbedingungen vorliegen. In jedem Fall wird demnach eine Verschlechterung der Immissionen durch das Vorhaben auftreten. Wir sollten vorab die aktuelle Genehmigungslage genau prüfen.  
\begin{table}[h!]
\centering
\renewcommand{\arraystretch}{1.5}
...
\hline
Immissionsorte&\cellcolor{ampelYellow!30} &\cellcolor{ampelYellow!30} \\
\hline
Nachbarbetriebe&\cellcolor{ampelYellow!30} &\cellcolor{ampelYellow!30} \\
\hline
Ist- und Plan-Zustand&\cellcolor{ampelGreen!30} &\cellcolor{ampelRed!30} \\
\hline
\end{tabularx}
...
\hline
Konditionierung von Minderungsmaßnahmen & Ja\\
\hline
\end{tabularx}
...
\begin{enumerate}
\item Gemeinsame Absprache zum weiteren Vorgehen bezüglich der immissionsschutzrechtlichen Beurteilung.
