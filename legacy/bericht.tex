...
\textbf{Adresse} & Kuhweg 11 bzw. 17 \\[0.1cm] % Ändern
\textbf{Ort} & 59457 Werl \\[0.1cm] % Ändern
\end{tabularx}
...
% Ändern
\textbf{Projektnummer} & G-6926-01 \\[0.1cm]
\textbf{Datum} & \today \\
\end{tabularx}
...
%Ändern
Der Betrieb befindet sich im Außenbereich südlich von Büderich inmitten weiterer landwirtschaftlicher Betriebe sowie schutzbedürftiger Nutzungen. Die Lage kann aus immissionsschutzfachlicher Sicht als schwierig eingestuft werden. Eine Übersicht über den Standort kann der Abbildung \ref{fig:lageplan} entnommen werden. 
\begin{figure}[htbp]
    \centering
...
\hline
% Ändern
\textbf{Begründung}&\cellcolor{ampelGreen!30} & \cellcolor{ampelGreen!30}Integrierte Lage \\
\hline
\end{tabularx}
...
\hline
% Ändern
\textbf{Begründung}&\cellcolor{ampelGreen!30} & \cellcolor{ampelGreen!30} Hohe Vorbelastung  \\
\hline
\end{tabularx}
...
\hline
Kolter Co. KG & Mastschweine & 1100 & 1 & Ja & Nein \\
Kolter Co. KG & Ferkelaufzucht & 1600 & 1 & Ja & Nein \\
Kolter & Mastschweine & 1499 & 1 & Ja & Nein \\
% Ändern
\hline
\end{tabularx}
...
\hline
Kolter Co. KG & Mastschweine & 850 & 3 \\
Kolter Co. KG & Ferkelaufzucht & 1600 & 1 \\
Kolter & Mastschweine & 1300 & 3 \\
% Ändern
\hline
\end{tabularx}
...
% Ändern
In diesem Projekt erwarten wir aus immissionsschutzfachlicher keine Probleme, da wir im Vergleich zwischen Ist- und Planzustand eine Verbesserung der Geruchsimmissionssituation darstellen können.   
\begin{table}[h!]
\centering
\renewcommand{\arraystretch}{1.5}
...
\hline
Nachbarbetriebe&\cellcolor{ampelGreen!30} &\cellcolor{ampelGreen!30} \\
\hline
...
\hline
Ermittlung der Stickstoffdeposition & Voraussichtlich Nein\\
\hline
Ausbreitungsberechnung Ist-Zustand & Ja\\
\hline
Ausbreitungsberechnung Plan-Zustand & Ja\\
\hline
Ausbreitungsberechnung Gesamtbelastung & Nein\\
\hline
Konditionierung von Minderungsmaßnahmen & Nein\\
\hline
\end{tabularx}
...
\item Ermittlung der Geruchsimmissionen durch Ausbreitungsberechnung und Abschätzung des weiteren Vorgehens. 
