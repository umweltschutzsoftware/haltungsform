...
\textbf{Adresse} & An der Eggel 2 \\[0.1cm] % Ändern
\textbf{Ort} & 34434 Borgentreich \\[0.1cm] % Ändern
\end{tabularx}
...
% Ändern
\textbf{Projektnummer} & G-6813-01 \\[0.1cm]
\textbf{Datum} & \today \\
\end{tabularx}
...
%Ändern
Das vorliegende Vorhaben betrifft die Errichtung eines Außenklimastalls als eigenständige Anlage.
\begin{table}[h!]
\centering
\renewcommand{\arraystretch}{1.5}
...
%Ändern
Der Betrieb befindet sich im Außenbereich der Stadt Schwerte, Gemarkung Borgentreich, Flur 41, Flurstück 50. Eine Übersicht über den Standort kann der Abbildung \ref{fig:lageplan} entnommen werden. 
\begin{figure}[htbp]
    \centering
...
\hline
% Ändern
\textbf{Begründung}&\cellcolor{ampelYellow!30} Kleinstbetriebe prüfen & \cellcolor{ampelGreen!30}  \\
\hline
\end{tabularx}
