...
\textbf{Adresse} & Reingsen 21 \\[0.1cm] % Ändern
\textbf{Ort} & 58239 Schwerte \\[0.1cm] % Ändern
\textbf{Koordinaten} & 51.40490, 7.62626 \\ % Ändern
\end{tabularx}
...
% Ändern
\textbf{Projektnummer} & G-6777-01 \\[0.1cm]
\textbf{Datum} & \today \\
\end{tabularx}
...
%Ändern
Das vorliegende Vorhaben betrifft die Änderung der Haltungsform innerhalb eines bestehenden landwirtschaftlichen Betriebes mit Schwerpunkt auf der Schweinehaltung. Das Stallgebäude befindet sich als eigenständige Anlage mit zugehörigen Nebeneinrichtung nördlich der landwirtschaftlichen Hofstelle.
\begin{table}[h!]
\centering
\renewcommand{\arraystretch}{1.5}
...
%Ändern
Der Betrieb befindet sich im Außenbereich der Stadt Schwerte, Gemarkung Engste, Flur 6, Flurstück 19 nördlich der landwirtschaftlichen Hofstelle. Eine Übersicht über den Standort kann der Abbildung \ref{fig:lageplan} entnommen werden. 
\begin{figure}[htbp]
    \centering
...
\hline
% Ändern
\textbf{Begründung}&\cellcolor{ampelGreen!30} & \cellcolor{ampelYellow!30} Biotope prüfen  \\
\hline
\end{tabularx}
...
% Ändern
Das Vorhaben erscheint grundsätzlich realisierbar. Bei der Vorabschätzung wurde davon ausgegangen, dass die Hofstelle und der Schweinstelle (mit den vorhandenen Nebeneinrichtungen) als getrennte Anlagen zu beurteilen sind. 
\begin{table}[h!]
\centering
\renewcommand{\arraystretch}{1.5}
...
\hline
Ausbreitungsberechnung Gesamtbelastung & Eher nein\\
\hline
