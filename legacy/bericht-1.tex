...
\textbf{Adresse} & Auf der Drift 7 \\[0.1cm]
\textbf{Ort} & 59329 Wadersloh-Liesborn \\[0.1cm]
\textbf{Koordinaten} & 51.7049457, 8.2994122 \\
\end{tabularx}

\vspace{2cm}
\begin{tabularx}{\textwidth\noindent}{@{}l X@{}}
\multicolumn{2}{@{}l}{\textbf{Projektinformationen}} \\[0.2cm]
\textbf{Projektnummer} & G-6725-01 \\[0.1cm]
\textbf{Datum} & \today \\
\end{tabularx}
...
Das vorliegende Vorhaben betrifft die Änderung der Haltungsform innerhalb eines bestehenden landwirtschaftlichen Betriebes mit Schwerpunkt auf der Schweinehaltung. Die Anlage unterliegt der Genehmigungspflicht nach dem Bundes-Immissionsschutzgesetz (BImSchG). 
\begin{table}[h!]
\centering
\renewcommand{\arraystretch}{1.5}
...
\hline
\textbf{Begründung}&\cellcolor{ampelYellow!30} Betrieb nach BImSchG & Kein Einfluss \\
\hline
\end{tabularx}
...
Der Betrieb befindet sich im Außenbereich der Gemeinde Wadersloh, Gemarkung Wadersloh, Flur 136, Flurstück 9 in Mitten eines landwirtschaftlich geprägten Bereiches. Eine Übersicht über den Standort kann der Abbildung \ref{fig:lageplan} entnommen werden. 
\begin{figure}[htbp]
    \centering
...
&\textbf{Aufwand} & \textbf{Schwierigkeit} \\
\hline
\textbf{Begründung}&\cellcolor{ampelGreen!30} & \cellcolor{ampelGreen!30}  \\
\hline
\end{tabularx}
...
&\textbf{Aufwand} & \textbf{Schwierigkeit} \\
\hline
\textbf{Begründung}&\cellcolor{ampelYellow!30} Große Anzahl benachbarter Betriebe & \cellcolor{ampelGreen!30}  \\
\hline
\end{tabularx}
...
\hline
01 & Mastschwein & 1.500 & 1 & ja & nein \\
02 & Mastschwein & 1.270 &1  & ja & nein \\
...
\hline
01 & Mastschwein & 1.300 & 2 \\
02 & Mastschwein & 1.270 & 1 \\
% Weitere Zeilen bei Bedarf ergänzen
\hline
\end{tabularx}
...
Das Vorhaben ist aus immissionsschutztechnischer Sicht mit einem erhöhten Aufwand verbunden, erscheint jedoch grundsätzlich realisierbar. Der Aufwand resultiert insbesondere aus der erforderlichen Genehmigung nach BImSchG sowie der damit verbundenen Ermittlung der bestehenden Gesamtbelastung.
\begin{table}[h!]
\centering
\renewcommand{\arraystretch}{1.5}
...
\hline
Genehmigungsrecht&\cellcolor{ampelYellow!30} & Kein Einfluss \\
\hline
Immissionsorte&\cellcolor{ampelGreen!30} &\cellcolor{ampelGreen!30} \\
\hline
Nachbarbetriebe&\cellcolor{ampelYellow!30} &\cellcolor{ampelGreen!30} \\
\hline
Ist- und Plan-Zustand&\cellcolor{ampelGreen!30} &\cellcolor{ampelGreen!30} \\
\hline
\end{tabularx}
...
\hline
Ermittlung der Stickstoffdeposition & Ja\\
\hline
Ausbreitungsberechnung Ist-Zustand & Ja\\
\hline
Ausbreitungsberechnung Plan-Zustand & Ja\\
\hline
Ausbreitungsberechnung Gesamtbelastung & Ja\\
\hline
...
\item Ermittlung der relevanten Betriebe, die als Vorbelastung für die Gesamtbelastungsbetrachtung herangezogen werden müssen.
\item Erhebung der Tierplatzzahlen und Anlagentypen der relevanten Betriebe.
\item Durchführung einer Gesamtbelastungsbetrachtung.
